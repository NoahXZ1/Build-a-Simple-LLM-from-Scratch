...
from ch4_Implementation_of_LLM_architecture import GPTModel, generate_text_simple
from ch2_data_processing import create_dataloader_v1

# NOTE: this module is imported by other chapter scripts (e.g. chp7) purely to reuse the
# functions below. Everything below is a reusable, side-effect-free def; all of chapter 5's
# demo code (model creation, GPU transfers, training, downloads, prints) lives in main() so
# that `import`ing this module doesn't re-run the whole chapter and blow up GPU memory.
